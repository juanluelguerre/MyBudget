...
{
	public class DataReadonlyRepositoryCustomerMock : IDataReadonlyService<Customer>
	{
		...
		{
			return Customer.CreateNew(id, "Juan Luis", "Guerrero Minero", DateTime.Now, Guid.NewGuid().ToString("N"));
		}
	}
}
